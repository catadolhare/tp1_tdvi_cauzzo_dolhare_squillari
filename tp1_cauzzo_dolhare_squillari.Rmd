...
best_predicciones <- predict(best_tree2, newdata = testeo, type = "class")
AUC(y_pred = best_predicciones, y_true = testeo$satisfaction)
```
```{r}
...
best_predicciones <- predict(best_tree3, newdata = testeo, type = "class")
AUC(y_pred = best_predicciones, y_true = testeo$satisfaction)
```
```{r}
...
AUC(y_pred = best_predicciones, y_true = testeo_na_50$satisfaction)
```
```{r}
...
AUC(y_pred = best_predicciones, y_true = testeo_na_75$satisfaction)
```
```{r}
