...
```
```{r}
best_na_20 <- buscar_hiperparametros(entrenamiento = entrenamiento_na_20, validacion = validacion_na_20, valores_maxdepth = valores_maxdepth2, valores_minsplit = valores_minsplit2, valores_minbucket = valores_minbucket2, valores_auc = valores_auc_na_20, best_auc = best_auc_na_20, best_params = best_params_na_20)
